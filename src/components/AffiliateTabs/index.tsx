          ...
          <div className="row">
            <div className="col-md-8 automargin">
              ...
              <p className="lead">
                ...
                which use Lykke API for trading bots. The more you share the
                link, the higher is the chance that you will bring at least one
              ...
              <ol className="list_styled">
                <li>
                  ...
                  <Link
                    ...
                    onClick={props.onReadRulesClicked}
                  >
                    read rules
                  </Link>.
                </li>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      . Trades for regular users are not subject of a
              ...
              <div className="form-group">
                <div className="checkbox">
                  <input
                    ...
                    checked={props.checkAgreement}
                    onChange={props.onChangeCheckAgreement}
                  />
                  <label
                    htmlFor="checkbox12"
            ...
            {!props.isAgreed && (
              <div className="form__submit">
                <button
                  ...
                  disabled={!props.checkAgreement}
                  onClick={props.onAgreeClicked}
                >
                  Agree and continue
                </button>
              </div>
...
export default withRouter(
  inject(({rootStore}: RootStoreProps) => ({
    checkAgreement: rootStore!.affiliateStore.checkAgreement,
    isAgreed: rootStore!.affiliateStore.isAgreed,
    onAgreeClicked: rootStore!.affiliateStore.onAgreeClicked,
    onChangeCheckAgreement: rootStore!.affiliateStore
      .handleChangeCheckedAgreement,
    onReadRulesClicked: () => window.scrollTo(0, 0)
  }))(observer(AffiliateTabs))
);
