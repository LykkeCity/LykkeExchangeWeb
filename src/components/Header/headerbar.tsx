            ...
            <div className="container">
              <div className="header_search__inner">
                <div className="header_search__buttons">
                  <button type="button" className="btn btn-sm btn--flat hidden-xs btn_close_header">Cancel</button>
                  <button type="button" className="btn btn-sm btn--primary hidden-xs">Search</button>
                  <button type="button" className="btn btn--icon visible-xs btn_close_header">
